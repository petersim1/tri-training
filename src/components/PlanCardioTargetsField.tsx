...
export function PlanCardioTargetsField({
  ...
  if (!["run", "bike", "swim"].includes(kind)) {
    return null;
  }
  ...
  async function save() {
    ...
    saveMutation.mutate({
      nextDist,
      nextUnits: nextUnits as CardioDistanceUnit,
      nextTime,
    });
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-end gap-1.5 sm:gap-2">
        <label className="min-w-18 flex-1">
